...
passHash        equ     1287h               ; hashed password (aSm101)
...
getBufferHash   proc            ; при 6-значном пароле который может состоять из любых символов таблицы размером в ~100
                                ...
                                ; вобщем ещё более реалистично
                                ; известно что пароль из 6 символов - большие, маленькие и цифры - итог 62
                                ; брутфорс будет чисто 62**6 / 500000000 что чуть меньше двух, но найдется быстрее
